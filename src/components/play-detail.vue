        ...
        <div class="playDetail" :style = "{'background-image': 'url(' + curPlayImgSrc + ')'}" v-if = "showDetail">
            ...
            <div class="playDetail-center">
                <div class="lrc-box" ref = "lrcBox" :style = "{transform: 'translateY(-' + translateY + 'px)', color: defaultColor}">
                    <p :style = "{color: curLrcIndex === index ? activeColor : ''}" :startTime = "lrcObj.startTime" v-for = "(lrcObj, index) in curPlayLrcArr" :key="index">{{ lrcObj.curLrc }}</p>
                </div>
            </div>
                ...
                <div class="lrcColor-box">
                    ...
                    <transition name = "fade">
                        <div class="color-list" v-if = "isShowColorList">
                            <ul>
                                <li v-for = "(currentObj, index) in lrcColorList" :style = "{backgroundImage: 'url('+ currentObj.currentImgSrc +')'}" @click = "changeLrcColor(index)" :key="index"></li>
                            </ul>
                        </div>
                    </transition>
                </div>
